...
# raw_data/ es el archivo "crudo" tal como sale del scraper, uno por corrida,
# y queda commiteado al repo (historial versionado por git), no es efímero
# como antes con output/.
...
ruta_json_dia    = os.path.join(data_dir, f"modificatorias_{fecha_dia}.json")
...
try:
    ...
    print("AVISO: supabase_sync.py no encontrado junto al scraper; se omite la sincronizacion.")
